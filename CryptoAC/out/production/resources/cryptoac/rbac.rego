...
# request should contain the "input" (here accessed through the "input." variable).
...
user_is_admin {
	...
	rbac.ur[input.user][i].username == "admin"
}
...
user_is_granted[grant] {
	...
	role := rbac.ur[input.user][i].roleName
