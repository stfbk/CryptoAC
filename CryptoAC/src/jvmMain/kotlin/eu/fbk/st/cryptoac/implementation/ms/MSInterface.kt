...
/** Abstract class defining the methods to interface with the MS. */
abstract class MSInterface {
     ...
     */
    abstract fun addUser(newUser: User): WrapperMSParameters
...
@Serializable
data class WrapperMSParameters(val code: OutcomeCode = OutcomeCode.CODE_000_SUCCESS, val parameters: MSInterfaceParameters? = null)