...
import eu.fbk.st.cryptoac.model.CodeSymmetricKeyABAC
...
/**
 * The CoreABACMQTT implements an attribute-based CAC scheme
...
) : CoreABACTuples(cryptoPKE, cryptoSKE, cryptoABE, coreParameters), MqttCallback {

    /** The MM service */
    override val mm: MMServiceABAC = MMFactory.getMM(
                            ...
                            when (enforcement) {
                                EnforcementType.COMBINED -> {
                                    ...
                                    if (subscribedTopicsKeysAndMessages.containsKey(topic)) {
                                        ...
                                        val topicVersionNumber = subscribedTopicsKeysAndMessages[topic]!!.versionNumber
