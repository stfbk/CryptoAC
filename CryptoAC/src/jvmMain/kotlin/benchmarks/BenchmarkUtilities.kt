...
class TestUtilities {
    companion object {
        ...
        val coreRBACMQTTNoACNoTLS: CoreRBACMQTT = CoreFactory.getCore(
            Parameters.adminCoreRBACMQTTParametersNoMosquittoNoTLS
        ) as CoreRBACMQTT
        val coreRBACMQTTNoACWithTLS: CoreRBACMQTT = CoreFactory.getCore(
            Parameters.adminCoreRBACMQTTParametersNoMosquittoWithTLS
        ) as CoreRBACMQTT
