...
external interface RBACCLOUDContentProps : RBACContentProps

external interface RBACCLOUDContentState : RBACContentState
 ...
 */
class CloudContent: RBACContent<RBACCLOUDContentProps, RBACCLOUDContentState>() {
     ...
     */
    override fun RBACCLOUDContentState.init() {
...
fun rbacCLOUDContent(handler: RBACCLOUDContentProps.() -> Unit): ReactElement {
    return createElement {
        child(CloudContent::class) {
            this.attrs(handler)
        }
    }!!
}