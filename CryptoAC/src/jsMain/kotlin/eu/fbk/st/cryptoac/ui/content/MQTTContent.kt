...
external interface MQTTContentProps : RProps {
...
external interface MQTTContentState : RState {
    /** The list of users. */
 ...
 */
class MQTTContent: RComponent<MQTTContentProps, MQTTContentState>() {
...
fun RBuilder.mqttContent(handler: MQTTContentProps.() -> Unit): ReactElement {
    return child(MQTTContent::class) {
        this.attrs(handler)
    }
}
