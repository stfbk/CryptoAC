...
/** Parameters, [port] and [url], for configuring the MM as a microservice container */
@Serializable
class DMInterfaceCloudParameters(var port: Int, var url: String) : DMInterfaceParameters() {
    ...
    override fun update(updatedParameters: DMInterfaceParameters) {
        if (updatedParameters is DMInterfaceCloudParameters) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as DMInterfaceCloudParameters
