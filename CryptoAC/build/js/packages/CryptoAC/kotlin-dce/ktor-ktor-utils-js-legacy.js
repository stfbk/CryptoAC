(function (root, factory) {
  ...
  HashFunction.$metadata$ = {kind: Kind_INTERFACE, simpleName: 'HashFunction', interfaces: []};
  ...
  Sha1.$metadata$ = {kind: Kind_CLASS, simpleName: 'Sha1', interfaces: [HashFunction]};
  ...
  GMTDateParser$Companion.$metadata$ = {kind: Kind_OBJECT, simpleName: 'Companion', interfaces: []};
  ...
  GMTDateParser.$metadata$ = {kind: Kind_CLASS, simpleName: 'GMTDateParser', interfaces: []};
  ...
  Object.defineProperty(GMTDateBuilder.prototype, 'month', {configurable: true, get: function () {
  ...
  GMTDateBuilder.$metadata$ = {kind: Kind_CLASS, simpleName: 'GMTDateBuilder', interfaces: []};
  ...
  InvalidDateStringException.$metadata$ = {kind: Kind_CLASS, simpleName: 'InvalidDateStringException', interfaces: [IllegalStateException]};
  ...
  Object.defineProperty(GMTDateParser, 'Companion', {get: GMTDateParser$Companion_getInstance});
