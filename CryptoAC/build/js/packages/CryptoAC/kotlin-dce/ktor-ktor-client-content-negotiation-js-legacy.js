(function (root, factory) {
  ...
  ContentNegotiation$Config$ConverterRegistration.$metadata$ = {kind: Kind_CLASS, simpleName: 'ConverterRegistration', interfaces: []};
  ...
  ContentNegotiation$Config$defaultMatcher$ObjectLiteral.$metadata$ = {kind: Kind_CLASS, interfaces: [ContentTypeMatcher]};
  ...
  ContentNegotiation$Config.$metadata$ = {kind: Kind_CLASS, simpleName: 'Config', interfaces: [Configuration]};
  ...
  Coroutine$convertRequest_y8o5zo$.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: null, interfaces: [CoroutineImpl]};
  ...
  Object.defineProperty(ContentNegotiation$Plugin.prototype, 'key', {configurable: true, get: function () {
  ...
  Coroutine$ContentNegotiation$Plugin$install$lambda.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: null, interfaces: [CoroutineImpl]};
  ...
  Coroutine$ContentNegotiation$Plugin$install$lambda_0.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: null, interfaces: [CoroutineImpl]};
  ...
  ContentNegotiation$Plugin.$metadata$ = {kind: Kind_OBJECT, simpleName: 'Plugin', interfaces: [HttpClientPlugin]};
  ...
  ContentNegotiation.$metadata$ = {kind: Kind_CLASS, simpleName: 'ContentNegotiation', interfaces: []};
  function ContentConverterException(message) {
    Exception_init(message, this);
    this.name = 'ContentConverterException';
  }
  ContentConverterException.$metadata$ = {kind: Kind_CLASS, simpleName: 'ContentConverterException', interfaces: [Exception]};
  ...
  JsonContentTypeMatcher.$metadata$ = {kind: Kind_OBJECT, simpleName: 'JsonContentTypeMatcher', interfaces: [ContentTypeMatcher]};
  ...
  Object.defineProperty(ContentNegotiation, 'Plugin', {get: ContentNegotiation$Plugin_getInstance});
  ...
  Object.defineProperty(package$contentnegotiation, 'JsonContentTypeMatcher', {get: JsonContentTypeMatcher_getInstance});
