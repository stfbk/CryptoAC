(function (root, factory) {
  ...
  Events$HandlerRegistration.$metadata$ = {kind: Kind_CLASS, simpleName: 'HandlerRegistration', interfaces: [DisposableHandle, LinkedListNode]};
  Events.$metadata$ = {kind: Kind_CLASS, simpleName: 'Events', interfaces: []};
  function EventDefinition() {
  }
  EventDefinition.$metadata$ = {kind: Kind_CLASS, simpleName: 'EventDefinition', interfaces: []};
