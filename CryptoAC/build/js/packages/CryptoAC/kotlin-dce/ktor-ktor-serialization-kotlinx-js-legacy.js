(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    define(['exports', 'kotlin', 'kotlinx-serialization-kotlinx-serialization-core-js-legacy', 'ktor-ktor-io-js-legacy', 'ktor-ktor-serialization-js-legacy', 'ktor-ktor-http-js-legacy', 'ktor-ktor-websockets-js-legacy'], factory);
  else if (typeof exports === 'object')
    factory(module.exports, require('kotlin'), require('kotlinx-serialization-kotlinx-serialization-core-js-legacy'), require('ktor-ktor-io-js-legacy'), require('ktor-ktor-serialization-js-legacy'), require('ktor-ktor-http-js-legacy'), require('ktor-ktor-websockets-js-legacy'));
  else {
    ...
    root['ktor-ktor-serialization-kotlinx-js-legacy'] = factory(typeof this['ktor-ktor-serialization-kotlinx-js-legacy'] === 'undefined' ? {} : this['ktor-ktor-serialization-kotlinx-js-legacy'], kotlin, this['kotlinx-serialization-kotlinx-serialization-core-js-legacy'], this['ktor-ktor-io-js-legacy'], this['ktor-ktor-serialization-js-legacy'], this['ktor-ktor-http-js-legacy'], this['ktor-ktor-websockets-js-legacy']);
  }
}(this, function (_, Kotlin, $module$kotlinx_serialization_kotlinx_serialization_core_js_legacy, $module$ktor_ktor_io_js_legacy, $module$ktor_ktor_serialization_js_legacy, $module$ktor_ktor_http_js_legacy, $module$ktor_ktor_websockets_js_legacy) {
  'use strict';
  ...
  var JsonConvertException = $module$ktor_ktor_serialization_js_legacy.io.ktor.serialization.JsonConvertException;
  var Throwable = Error;
  ...
  Coroutine$serialize_jhffn2$.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: null, interfaces: [CoroutineImpl]};
  ...
  KotlinxSerializationBase.$metadata$ = {kind: Kind_CLASS, simpleName: 'KotlinxSerializationBase', interfaces: []};
  ...
  Object.defineProperty(SerializationParameters.prototype, 'format', {get: function () {
    return this.format_rzncps$_0;
  }});
  Object.defineProperty(SerializationParameters.prototype, 'value', {get: function () {
    return this.value_7rzid0$_0;
  }});
  Object.defineProperty(SerializationParameters.prototype, 'typeInfo', {get: function () {
    return this.typeInfo_r8asj3$_0;
  }});
  Object.defineProperty(SerializationParameters.prototype, 'charset', {get: function () {
    return this.charset_v8qo0h$_0;
  }});
  Object.defineProperty(SerializationParameters.prototype, 'serializer', {configurable: true, get: function () {
  ...
  SerializationParameters.$metadata$ = {kind: Kind_CLASS, simpleName: 'SerializationParameters', interfaces: []};
  ...
  Object.defineProperty(SerializationNegotiationParameters.prototype, 'format', {get: function () {
    return this.format_wmbrjz$_0;
  }});
  Object.defineProperty(SerializationNegotiationParameters.prototype, 'value', {get: function () {
    return this.value_no0ss3$_0;
  }});
  Object.defineProperty(SerializationNegotiationParameters.prototype, 'typeInfo', {get: function () {
    return this.typeInfo_1nvg3y$_0;
  }});
  Object.defineProperty(SerializationNegotiationParameters.prototype, 'charset', {get: function () {
    return this.charset_wpjc2a$_0;
  }});
  SerializationNegotiationParameters.$metadata$ = {kind: Kind_CLASS, simpleName: 'SerializationNegotiationParameters', interfaces: [SerializationParameters]};
  ...
  KotlinxSerializationConverter.prototype.serializeNullable_koybg$ = function (contentType, charset, typeInfo, value, continuation) {
  ...
  Coroutine$deserialize_obau6j$.$metadata$ = {kind: Kotlin.Kind.CLASS, simpleName: null, interfaces: [CoroutineImpl]};
  ...
  KotlinxSerializationConverter$serializationBase$ObjectLiteral.$metadata$ = {kind: Kind_CLASS, interfaces: [KotlinxSerializationBase]};
  KotlinxSerializationConverter.$metadata$ = {kind: Kind_CLASS, simpleName: 'KotlinxSerializationConverter', interfaces: [ContentConverter]};
  ...
  function serializerFromTypeInfo(typeInfo, module_0) {
    ...
    return (tmp$_2 = (tmp$_1 = (tmp$ = typeInfo.kotlinType) != null ? tmp$.arguments.isEmpty() ? null : serializerOrNull(module_0, tmp$) : null) != null ? tmp$_1 : (tmp$_0 = module_0.getContextual_2n2k9f$(typeInfo.type)) != null ? maybeNullable(tmp$_0, typeInfo) : null) != null ? tmp$_2 : maybeNullable(serializer(typeInfo.type), typeInfo);
  }
  function maybeNullable($receiver, typeInfo) {
    var tmp$;
    return ((tmp$ = typeInfo.kotlinType) != null ? tmp$.isMarkedNullable : null) === true ? get_nullable($receiver) : $receiver;
  }
  function guessSerializer(value, module_0) {
    var tmp$, tmp$_0, tmp$_1, tmp$_2, tmp$_3;
    if (value == null)
      tmp$_2 = get_nullable(serializer_0(kotlin_js_internal_StringCompanionObject));
  ...
  package$kotlinx.guessSerializer_mukf8o$ = guessSerializer;
  return _;
}));
