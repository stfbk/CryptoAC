(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    define(['exports', 'kotlin', 'ktor-ktor-http-js-legacy', 'kotlinx-serialization-kotlinx-serialization-core-js-legacy', 'kotlinx-serialization-kotlinx-serialization-json-js-legacy', 'ktor-ktor-client-json-js-legacy'], factory);
  else if (typeof exports === 'object')
    factory(module.exports, require('kotlin'), require('ktor-ktor-http-js-legacy'), require('kotlinx-serialization-kotlinx-serialization-core-js-legacy'), require('kotlinx-serialization-kotlinx-serialization-json-js-legacy'), require('ktor-ktor-client-json-js-legacy'));
  else {
    ...
    root['ktor-ktor-client-serialization-js-legacy'] = factory(typeof this['ktor-ktor-client-serialization-js-legacy'] === 'undefined' ? {} : this['ktor-ktor-client-serialization-js-legacy'], kotlin, this['ktor-ktor-http-js-legacy'], this['kotlinx-serialization-kotlinx-serialization-core-js-legacy'], this['kotlinx-serialization-kotlinx-serialization-json-js-legacy'], this['ktor-ktor-client-json-js-legacy']);
  }
}(this, function (_, Kotlin, $module$ktor_ktor_http_js_legacy, $module$kotlinx_serialization_kotlinx_serialization_core_js_legacy, $module$kotlinx_serialization_kotlinx_serialization_json_js_legacy, $module$ktor_ktor_client_json_js_legacy) {
  'use strict';
  ...
  var JsonSerializer = $module$ktor_ktor_client_json_js_legacy.io.ktor.client.plugins.json.JsonSerializer;
  ...
  var json = $module$ktor_ktor_client_json_js_legacy.io.ktor.client.plugins.json;
  ...
  var package$kotlinx = package$plugins.kotlinx || (package$plugins.kotlinx = {});
  var package$serializer = package$kotlinx.serializer || (package$kotlinx.serializer = {});
