(function (root, factory) {
  ...
  Appender.$metadata$ = {kind: Kind_INTERFACE, simpleName: 'Appender', interfaces: []};
  ...
  ConsoleOutputAppender.$metadata$ = {kind: Kind_OBJECT, simpleName: 'ConsoleOutputAppender', interfaces: [Appender]};
  ...
  DefaultMessageFormatter.prototype.formatMessage_pijeg6$ = function (level, loggerName, msg) {
    ...
    try {
      ...
      if (Kotlin.isType(e, Exception)) {
        tmp$_0 = package$internal.ErrorMessageProducer.getErrorLog_3lhtaa$(e);
      } else
        throw e;
    }
    return tmp$ + tmp$_0;
  ...
  DefaultMessageFormatter.$metadata$ = {kind: Kind_OBJECT, simpleName: 'DefaultMessageFormatter', interfaces: [Formatter]};
  ...
  Formatter.$metadata$ = {kind: Kind_INTERFACE, simpleName: 'Formatter', interfaces: []};
  function KLogger() {
  }
  KLogger.$metadata$ = {kind: Kind_INTERFACE, simpleName: 'KLogger', interfaces: []};
  ...
  KotlinLogging.$metadata$ = {kind: Kind_OBJECT, simpleName: 'KotlinLogging', interfaces: []};
  ...
  KotlinLoggingConfiguration.$metadata$ = {kind: Kind_OBJECT, simpleName: 'KotlinLoggingConfiguration', interfaces: []};
  ...
  KotlinLoggingLevel.$metadata$ = {kind: Kind_CLASS, simpleName: 'KotlinLoggingLevel', interfaces: [Enum]};
  ...
  function KotlinLoggingLevel$valueOf(name) {
    switch (name) {
      ...
      default:
        throwISE('No enum constant mu.KotlinLoggingLevel.' + name);
    }
  }
  ...
  ErrorMessageProducer.prototype.getErrorLog_3lhtaa$ = function (e) {
    return 'Log message invocation failed: ' + e;
  };
  ErrorMessageProducer.$metadata$ = {kind: Kind_OBJECT, simpleName: 'ErrorMessageProducer', interfaces: []};
  var ErrorMessageProducer_instance = null;
  ...
  KLoggerJS.prototype.trace_nq59yw$ = function (msg) {
    this.logIfEnabled_0(KotlinLoggingLevel$TRACE_getInstance(), msg, getCallableRef('trace', function ($receiver, p1) {
  ...
  KLoggerJS.prototype.debug_nq59yw$ = function (msg) {
    this.logIfEnabled_0(KotlinLoggingLevel$DEBUG_getInstance(), msg, getCallableRef('debug', function ($receiver, p1) {
      return $receiver.debug_s8jyv4$(p1), Unit;
    }.bind(null, KotlinLoggingConfiguration_getInstance().APPENDER)));
  };
  KLoggerJS.prototype.info_nq59yw$ = function (msg) {
    this.logIfEnabled_0(KotlinLoggingLevel$INFO_getInstance(), msg, getCallableRef('info', function ($receiver, p1) {
      return $receiver.info_s8jyv4$(p1), Unit;
    }.bind(null, KotlinLoggingConfiguration_getInstance().APPENDER)));
  };
  KLoggerJS.prototype.warn_nq59yw$ = function (msg) {
    this.logIfEnabled_0(KotlinLoggingLevel$WARN_getInstance(), msg, getCallableRef('warn', function ($receiver, p1) {
      return $receiver.warn_s8jyv4$(p1), Unit;
    }.bind(null, KotlinLoggingConfiguration_getInstance().APPENDER)));
  };
  KLoggerJS.prototype.error_nq59yw$ = function (msg) {
    this.logIfEnabled_0(KotlinLoggingLevel$ERROR_getInstance(), msg, getCallableRef('error', function ($receiver, p1) {
      return $receiver.error_s8jyv4$(p1), Unit;
    }.bind(null, KotlinLoggingConfiguration_getInstance().APPENDER)));
  };
  KLoggerJS.prototype.trace_ca4k3s$ = function (t, msg) {
    this.logIfEnabled_1(KotlinLoggingLevel$TRACE_getInstance(), msg, t, getCallableRef('trace', function ($receiver, p1) {
      return $receiver.trace_s8jyv4$(p1), Unit;
    }.bind(null, KotlinLoggingConfiguration_getInstance().APPENDER)));
  };
  KLoggerJS.prototype.debug_ca4k3s$ = function (t, msg) {
    this.logIfEnabled_1(KotlinLoggingLevel$DEBUG_getInstance(), msg, t, getCallableRef('debug', function ($receiver, p1) {
      return $receiver.debug_s8jyv4$(p1), Unit;
    }.bind(null, KotlinLoggingConfiguration_getInstance().APPENDER)));
  };
  KLoggerJS.prototype.info_ca4k3s$ = function (t, msg) {
    this.logIfEnabled_1(KotlinLoggingLevel$INFO_getInstance(), msg, t, getCallableRef('info', function ($receiver, p1) {
      return $receiver.info_s8jyv4$(p1), Unit;
    }.bind(null, KotlinLoggingConfiguration_getInstance().APPENDER)));
  };
  KLoggerJS.prototype.warn_ca4k3s$ = function (t, msg) {
    this.logIfEnabled_1(KotlinLoggingLevel$WARN_getInstance(), msg, t, getCallableRef('warn', function ($receiver, p1) {
      return $receiver.warn_s8jyv4$(p1), Unit;
    }.bind(null, KotlinLoggingConfiguration_getInstance().APPENDER)));
  };
  KLoggerJS.prototype.error_ca4k3s$ = function (t, msg) {
    this.logIfEnabled_1(KotlinLoggingLevel$ERROR_getInstance(), msg, t, getCallableRef('error', function ($receiver, p1) {
      return $receiver.error_s8jyv4$(p1), Unit;
    }.bind(null, KotlinLoggingConfiguration_getInstance().APPENDER)));
  };
  KLoggerJS.prototype.trace_8jakm3$ = function (marker, msg) {
    this.logIfEnabled_2(KotlinLoggingLevel$TRACE_getInstance(), marker, msg, getCallableRef('trace', function ($receiver, p1) {
      return $receiver.trace_s8jyv4$(p1), Unit;
    }.bind(null, KotlinLoggingConfiguration_getInstance().APPENDER)));
  };
  KLoggerJS.prototype.debug_8jakm3$ = function (marker, msg) {
    this.logIfEnabled_2(KotlinLoggingLevel$DEBUG_getInstance(), marker, msg, getCallableRef('debug', function ($receiver, p1) {
      return $receiver.debug_s8jyv4$(p1), Unit;
    }.bind(null, KotlinLoggingConfiguration_getInstance().APPENDER)));
  };
  KLoggerJS.prototype.info_8jakm3$ = function (marker, msg) {
    this.logIfEnabled_2(KotlinLoggingLevel$INFO_getInstance(), marker, msg, getCallableRef('info', function ($receiver, p1) {
      return $receiver.info_s8jyv4$(p1), Unit;
    }.bind(null, KotlinLoggingConfiguration_getInstance().APPENDER)));
  };
  KLoggerJS.prototype.warn_8jakm3$ = function (marker, msg) {
    this.logIfEnabled_2(KotlinLoggingLevel$WARN_getInstance(), marker, msg, getCallableRef('warn', function ($receiver, p1) {
      return $receiver.warn_s8jyv4$(p1), Unit;
    }.bind(null, KotlinLoggingConfiguration_getInstance().APPENDER)));
  };
  KLoggerJS.prototype.error_8jakm3$ = function (marker, msg) {
    this.logIfEnabled_2(KotlinLoggingLevel$ERROR_getInstance(), marker, msg, getCallableRef('error', function ($receiver, p1) {
      return $receiver.error_s8jyv4$(p1), Unit;
    }.bind(null, KotlinLoggingConfiguration_getInstance().APPENDER)));
  };
  KLoggerJS.prototype.trace_o4svvp$ = function (marker, t, msg) {
    this.logIfEnabled_3(KotlinLoggingLevel$TRACE_getInstance(), marker, msg, t, getCallableRef('trace', function ($receiver, p1) {
      return $receiver.trace_s8jyv4$(p1), Unit;
    }.bind(null, KotlinLoggingConfiguration_getInstance().APPENDER)));
  };
  KLoggerJS.prototype.debug_o4svvp$ = function (marker, t, msg) {
    this.logIfEnabled_3(KotlinLoggingLevel$DEBUG_getInstance(), marker, msg, t, getCallableRef('debug', function ($receiver, p1) {
      return $receiver.debug_s8jyv4$(p1), Unit;
    }.bind(null, KotlinLoggingConfiguration_getInstance().APPENDER)));
  };
  KLoggerJS.prototype.info_o4svvp$ = function (marker, t, msg) {
    this.logIfEnabled_3(KotlinLoggingLevel$INFO_getInstance(), marker, msg, t, getCallableRef('info', function ($receiver, p1) {
      return $receiver.info_s8jyv4$(p1), Unit;
    }.bind(null, KotlinLoggingConfiguration_getInstance().APPENDER)));
  };
  KLoggerJS.prototype.warn_o4svvp$ = function (marker, t, msg) {
    this.logIfEnabled_3(KotlinLoggingLevel$WARN_getInstance(), marker, msg, t, getCallableRef('warn', function ($receiver, p1) {
      return $receiver.warn_s8jyv4$(p1), Unit;
    }.bind(null, KotlinLoggingConfiguration_getInstance().APPENDER)));
  };
  KLoggerJS.prototype.error_o4svvp$ = function (marker, t, msg) {
    this.logIfEnabled_3(KotlinLoggingLevel$ERROR_getInstance(), marker, msg, t, getCallableRef('error', function ($receiver, p1) {
      return $receiver.error_s8jyv4$(p1), Unit;
    }.bind(null, KotlinLoggingConfiguration_getInstance().APPENDER)));
  };
  ...
  KLoggerJS.prototype.entry_yhszz7$ = function (argArray) {
    this.logIfEnabled_0(KotlinLoggingLevel$TRACE_getInstance(), KLoggerJS$entry$lambda(argArray), getCallableRef('trace', function ($receiver, p1) {
      return $receiver.trace_s8jyv4$(p1), Unit;
    }.bind(null, KotlinLoggingConfiguration_getInstance().APPENDER)));
  };
  ...
  KLoggerJS.prototype.exit = function () {
    this.logIfEnabled_0(KotlinLoggingLevel$TRACE_getInstance(), KLoggerJS$exit$lambda, getCallableRef('trace', function ($receiver, p1) {
      return $receiver.trace_s8jyv4$(p1), Unit;
    }.bind(null, KotlinLoggingConfiguration_getInstance().APPENDER)));
  };
  ...
  KLoggerJS.prototype.exit_mh5how$ = function (result) {
    this.logIfEnabled_0(KotlinLoggingLevel$TRACE_getInstance(), KLoggerJS$exit$lambda_0(result), getCallableRef('trace', function ($receiver, p1) {
      return $receiver.trace_s8jyv4$(p1), Unit;
    }.bind(null, KotlinLoggingConfiguration_getInstance().APPENDER)));
    return result;
  };
  ...
  KLoggerJS.prototype.throwing_849n7l$ = function (throwable) {
    this.logIfEnabled_1(KotlinLoggingLevel$ERROR_getInstance(), KLoggerJS$throwing$lambda(throwable), throwable, getCallableRef('error', function ($receiver, p1) {
      return $receiver.error_s8jyv4$(p1), Unit;
    }.bind(null, KotlinLoggingConfiguration_getInstance().APPENDER)));
    return throwable;
  };
  ...
  KLoggerJS.prototype.catching_849n7l$ = function (throwable) {
    this.logIfEnabled_1(KotlinLoggingLevel$ERROR_getInstance(), KLoggerJS$catching$lambda(throwable), throwable, getCallableRef('error', function ($receiver, p1) {
      return $receiver.error_s8jyv4$(p1), Unit;
    }.bind(null, KotlinLoggingConfiguration_getInstance().APPENDER)));
  };
  KLoggerJS.$metadata$ = {kind: Kind_CLASS, simpleName: 'KLoggerJS', interfaces: [KLogger]};
  var package$mu = _.mu || (_.mu = {});
  var package$internal = package$mu.internal || (package$mu.internal = {});
  package$mu.Appender = Appender;
  Object.defineProperty(package$mu, 'ConsoleOutputAppender', {get: ConsoleOutputAppender_getInstance});
  Object.defineProperty(package$mu, 'DefaultMessageFormatter', {get: DefaultMessageFormatter_getInstance});
  package$mu.Formatter = Formatter;
  package$mu.KLogger = KLogger;
  Object.defineProperty(package$mu, 'KotlinLogging', {get: KotlinLogging_getInstance});
  Object.defineProperty(package$mu, 'KotlinLoggingConfiguration', {get: KotlinLoggingConfiguration_getInstance});
  Object.defineProperty(KotlinLoggingLevel, 'TRACE', {get: KotlinLoggingLevel$TRACE_getInstance});
  Object.defineProperty(KotlinLoggingLevel, 'DEBUG', {get: KotlinLoggingLevel$DEBUG_getInstance});
  Object.defineProperty(KotlinLoggingLevel, 'INFO', {get: KotlinLoggingLevel$INFO_getInstance});
  Object.defineProperty(KotlinLoggingLevel, 'WARN', {get: KotlinLoggingLevel$WARN_getInstance});
  Object.defineProperty(KotlinLoggingLevel, 'ERROR', {get: KotlinLoggingLevel$ERROR_getInstance});
  package$mu.KotlinLoggingLevel = KotlinLoggingLevel;
  package$mu.isLoggingEnabled_pm19j7$ = isLoggingEnabled;
  Object.defineProperty(package$internal, 'ErrorMessageProducer', {get: ErrorMessageProducer_getInstance});
