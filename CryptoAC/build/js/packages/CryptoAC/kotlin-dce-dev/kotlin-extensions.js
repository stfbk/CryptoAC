(function (_, Kotlin) {
  ...
  var get = defineInlineFunction('kotlin-extensions.kotlinext.js.get_3llx5$', function ($receiver, key) {
    return $receiver[key];
  });
  var set = defineInlineFunction('kotlin-extensions.kotlinext.js.set_ne2z2k$', function ($receiver, key, value) {
    $receiver[key] = value;
  });
