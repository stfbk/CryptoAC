(function (root, factory) {
  ...
  function flex($receiver, flexGrow) {
    $receiver.put_puj7f4$('flex', flexGrow.toString());
  }
  function flex_0($receiver, flexBasis) {
    $receiver.put_puj7f4$('flex', flexBasis.toString());
  }
  function flex_1($receiver, flexGrow, flexShrink) {
    $receiver.put_puj7f4$('flex', flexGrow.toString() + ' ' + flexShrink.toString());
  }
  function flex_2($receiver, flexGrow, flexBasis) {
    $receiver.put_puj7f4$('flex', flexGrow.toString() + ' ' + flexBasis);
  }
  function flex_3($receiver, flexGrow, flexShrink, flexBasis) {
    $receiver.put_puj7f4$('flex', flexGrow.toString() + ' ' + flexShrink.toString() + ' ' + flexBasis);
  }
  function flex_4($receiver, flexGrow, flexShrink, flexBasis) {
    flex_3($receiver, flexGrow, flexShrink, get_basis(flexBasis));
  }
  function grow($receiver, grow) {
    switch (grow.name) {
      case 'GROW':
        flex_4($receiver, 1, 0, LinearDimension$Companion_getInstance().auto);
        break;
      case 'SHRINK':
        flex_4($receiver, 0, 1, LinearDimension$Companion_getInstance().auto);
        break;
      case 'NONE':
        flex_4($receiver, 0, 0, LinearDimension$Companion_getInstance().auto);
        break;
      case 'GROW_SHRINK':
        flex_4($receiver, 1, 1, LinearDimension$Companion_getInstance().auto);
        break;
    }
  }
  ...
  package$css.set_flexGrow_if475a$ = set_flexGrow;
  package$css.get_flexShrink_z7t51k$ = get_flexShrink;
  package$css.set_flexShrink_if475a$ = set_flexShrink;
  ...
  package$css.flex_if475a$ = flex;
  package$css.flex_n8chyh$ = flex_0;
  package$css.flex_toeebs$ = flex_1;
  package$css.flex_jvwuap$ = flex_2;
  package$css.flex_viwnyp$ = flex_3;
  package$css.flex_4kgp1x$ = flex_4;
