(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    define(['exports', 'kotlin', 'kotlin-css', 'kotlin-react-dom-legacy', 'kotlin-extensions', 'inline-style-prefixer', 'kotlin-react-legacy', 'styled-components', 'react', 'react-dom', 'react', 'kotlinx-html-js', 'styled-components'], factory);
  else if (typeof exports === 'object')
    factory(module.exports, require('kotlin'), require('kotlin-css'), require('kotlin-react-dom-legacy'), require('kotlin-extensions'), require('inline-style-prefixer'), require('kotlin-react-legacy'), require('styled-components'), require('react'), require('react-dom'), require('react'), require('kotlinx-html-js'), require('styled-components'));
  else {
    if (typeof kotlin === 'undefined') {
      ...
      throw new Error("Error loading module 'kotlin-styled'. Its dependency 'styled-components' was not found. Please, check whether 'styled-components' is loaded prior to 'kotlin-styled'.");
    }root['kotlin-styled'] = factory(typeof this['kotlin-styled'] === 'undefined' ? {} : this['kotlin-styled'], kotlin, this['kotlin-css'], this['kotlin-react-dom-legacy'], this['kotlin-extensions'], this['inline-style-prefixer'], this['kotlin-react-legacy'], this['styled-components'], react, this['react-dom'], ReactModule, this['kotlinx-html-js'], StyledComponents);
  }
}(this, function (_, Kotlin, $module$kotlin_css, $module$kotlin_react_dom_legacy, $module$kotlin_extensions, $module$inline_style_prefixer, $module$kotlin_react_legacy, $module$styled_components, $module$react, $module$react_dom, $module$react_0, $module$kotlinx_html_js, $module$styled_components_0) {
  'use strict';
  ...
  var fc = $module$kotlin_react_legacy.react.fc_4mavxa$;
  ...
  StyleSheet.prototype.inject = function () {
    if (!this.isLoaded_1mk3xi$_0 && this.isStatic) {
      ...
      var $receiver_1 = CssBuilder(void 0, false, void 0, void 0, true);
      var tmp$_1;
  ...
  function injectGlobal_1(handler) {
    var $receiver = CssBuilder(void 0, void 0, void 0, void 0, true);
    handler($receiver);
