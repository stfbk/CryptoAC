(function(root, factory) {
  ...
  var Any = Object;
  var sharedMap = $module$ktor_ktor_utils_js_legacy.io.ktor.util.collections.sharedMap_zhjvlt$;
  ...
  var sharedList = $module$ktor_ktor_utils_js_legacy.io.ktor.util.collections.sharedList_287e2$;
  ...
  if (closure$respectRetryAfterHeader) {
    var retryAfter = (tmp$_1 = (tmp$_0 = (tmp$ = $receiver.response) != null ? tmp$.headers : null) != null ? tmp$_0.get_61zpoe$(http.HttpHeaders.RetryAfter) : null) != null ? toLongOrNull(tmp$_1) : null;
  ...
  function HttpTimeout$HttpTimeoutCapabilityConfiguration() {
    ...
    this._requestTimeoutMillis_yk9qkg$_0 = new shared$ObjectLiteral_1(L0);
    this._connectTimeoutMillis_65i5np$_0 = new shared$ObjectLiteral_1(L0);
    this._socketTimeoutMillis_hq3au0$_0 = new shared$ObjectLiteral_1(L0);
  }
  ...
  function Coroutine$HttpTimeout$Plugin$install$lambda$lambda$lambda(closure$requestTimeout_0, this$_0, closure$executionContext_0, $receiver_0, controller, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.$controller = controller;
    this.exceptionState_0 = 1;
  ...
  do try {
    switch (this.state_0) {
      ...
      case 1:
        throw this.exception_0;
      case 2:
        var cause = new HttpRequestTimeoutException(this.local$this$.context);
  ...
  function HttpTimeout$Plugin$install$lambda$lambda$lambda(closure$requestTimeout_0, this$_0, closure$executionContext_0) {
    return function($receiver_0, continuation_0, suspended) {
  var instance = new Coroutine$HttpTimeout$Plugin$install$lambda$lambda$lambda(closure$requestTimeout_0, this$_0, closure$executionContext_0, $receiver_0, this, continuation_0);
  if (suspended) 
    return instance;
  else 
    return instance.doResume(null);
        ...
        if (configuration != null) {
          ...
          block$break:
            do {
              ...
              var killer = launch(closure$scope, void 0, void 0, HttpTimeout$Plugin$install$lambda$lambda$lambda(requestTimeout, this.local$$receiver, executionContext));
  ...
  function get_converter($receiver) {
    var tmp$, tmp$_0;
    return (tmp$_0 = (tmp$ = $receiver.call.client) != null ? pluginOrNull(tmp$, WebSockets$Plugin_getInstance()) : null) != null ? tmp$_0.contentConverter : null;
  }
