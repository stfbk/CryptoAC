(function (root, factory) {
  ...
  function encodeURLPath($receiver) {
    return encodeURLPath_0($receiver, false);
  }
  ...
  function toHeaderParamsList($receiver) {
    ...
    while (tmp$.hasNext()) {
      var item = tmp$.next();
      destination.add_11rb$(HeaderValueParam_init(item.first, item.second));
    }
    return destination;
  }
  ...
  function LinkHeader_init(uri, rel, $this) {
    ...
    LinkHeader.call($this, uri, listOf_0(HeaderValueParam_init(LinkHeader$Parameters_getInstance().Rel, rel)));
    return $this;
  }
  function LinkHeader_init_0(uri, rel, $this) {
    $this = $this || Object.create(LinkHeader.prototype);
    LinkHeader.call($this, uri, listOf_0(HeaderValueParam_init(LinkHeader$Parameters_getInstance().Rel, joinToString_0(rel, ' '))));
    return $this;
  }
  function LinkHeader_init_1(uri, rel, type, $this) {
    $this = $this || Object.create(LinkHeader.prototype);
    LinkHeader.call($this, uri, listOf([HeaderValueParam_init(LinkHeader$Parameters_getInstance().Rel, joinToString(rel, ' ')), HeaderValueParam_init(LinkHeader$Parameters_getInstance().Type, type.toString())]));
    return $this;
  }
  ...
  function appendPathSegments($receiver, segments, encodeSlash) {
    if (encodeSlash === void 0)
      encodeSlash = false;
    var tmp$;
    if (!encodeSlash) {
      var destination = ArrayList_init_0();
      ...
      while (tmp$_0.hasNext()) {
        var element = tmp$_0.next();
        var list = split_0(element, Kotlin.charArrayOf(47));
        addAll(destination, list);
      }
      tmp$ = destination;
    } else
    ...
    var destination_0 = ArrayList_init(collectionSizeOrDefault(pathSegments, 10));
    var tmp$_1;
    tmp$_1 = pathSegments.iterator();
    while (tmp$_1.hasNext()) {
      var item = tmp$_1.next();
      destination_0.add_11rb$(encodeURLPathPart(item));
    }
    var encodedSegments = destination_0;
    appendEncodedPathSegments($receiver, encodedSegments);
    return $receiver;
  }
  function appendPathSegments_0($receiver, components, encodeSlash) {
    if (encodeSlash === void 0)
      encodeSlash = false;
    return appendPathSegments($receiver, toList_0(components), encodeSlash);
  }
  function path($receiver, path) {
    var destination = ArrayList_init(path.length);
    var tmp$;
    for (tmp$ = 0; tmp$ !== path.length; ++tmp$) {
      var item = path[tmp$];
      destination.add_11rb$(encodeURLPath(item));
    }
    $receiver.encodedPathSegments = destination;
  }
  function appendEncodedPathSegments($receiver, segments) {
    var tmp$;
    var tmp$_0 = $receiver.encodedPathSegments.size > 1;
    if (tmp$_0) {
      tmp$_0 = last($receiver.encodedPathSegments).length === 0;
    }
    var tmp$_1 = tmp$_0;
    if (tmp$_1) {
      tmp$_1 = !segments.isEmpty();
    }
    var endsWithSlash = tmp$_1;
    var tmp$_2 = segments.size > 1;
    if (tmp$_2) {
      tmp$_2 = first_0(segments).length === 0;
    }
    var tmp$_3 = tmp$_2;
    if (tmp$_3) {
      tmp$_3 = !$receiver.encodedPathSegments.isEmpty();
    }
    var startWithSlash = tmp$_3;
    if (endsWithSlash && startWithSlash)
      tmp$ = plus_0(dropLast($receiver.encodedPathSegments, 1), drop(segments, 1));
    else if (endsWithSlash)
      tmp$ = plus_0(dropLast($receiver.encodedPathSegments, 1), segments);
    else if (startWithSlash)
      tmp$ = plus_0($receiver.encodedPathSegments, drop(segments, 1));
    else
      tmp$ = plus_0($receiver.encodedPathSegments, segments);
  ...
  function appendPathSegments_1($receiver, segments) {
    return appendPathSegments($receiver, segments, false);
  }
  function appendPathSegments_2($receiver, components) {
    return appendPathSegments($receiver, toList_0(components), false);
  }
  ...
  HttpAuthHeader$Parameterized.prototype.withParameter_puj7f4$ = function (name, value) {
    return new HttpAuthHeader$Parameterized(this.authScheme, plus_2(this.parameters, HeaderValueParam_init(name, value)), this.encoding);
  };
  HttpAuthHeader$Parameterized.prototype.withReplacedParameter_puj7f4$ = function (name, value) {
    ...
    while (tmp$_0.hasNext()) {
      ...
      if (!equals(element.name, name)) {
        ...
        replaced.v = true;
        transform$result = HeaderValueParam_init(name, value);
      } else {
  ...
  function HttpAuthHeader$HttpAuthHeader$Parameterized_init(authScheme, parameters, encoding, $this) {
    ...
    while (tmp$.hasNext()) {
      var item = tmp$.next();
      destination.add_11rb$(HeaderValueParam_init(item.key, item.value));
    }
  ...
  Object.defineProperty(package$http, 'ATTRIBUTE_CHARACTERS_8be2vx$', {
    get: function () {
  ...
  package$http.appendPathSegments_a4ktkl$ = appendPathSegments;
  package$http.appendPathSegments_x95ktj$ = appendPathSegments_0;
  ...
  package$http.appendPathSegments_qmwsk$ = appendPathSegments_1;
  package$http.appendPathSegments_7buj3i$ = appendPathSegments_2;
  ...
  Object.defineProperty(package$content, 'NullBody', {
    get: NullBody_getInstance
  });
