(function(root, factory) {
  ...
  function sharedLazy$ObjectLiteral(closure$function) {
    this.closure$function = closure$function;
    this.value = null;
  }
  sharedLazy$ObjectLiteral.prototype.getValue_lrcp0p$ = function(thisRef, property) {
  this.closure$function;
  var closure$function = this.closure$function;
  if (this.value == null) {
    this.value = closure$function();
  }
  return ensureNotNull(this.value);
};
  sharedLazy$ObjectLiteral.$metadata$ = {
  kind: Kind_CLASS, 
  interfaces: [ReadOnlyProperty]};
  function sharedLazy(function_0) {
    return new sharedLazy$ObjectLiteral(function_0);
  }
