(function (_, Kotlin, $module$kotlin_css, $module$kotlin_extensions, $module$inline_style_prefixer, $module$kotlin_react, $module$kotlin_react_dom, $module$styled_components, $module$react, $module$react_dom, $module$kotlinx_html_js) {
  'use strict';
  ...
  var functionalComponent = $module$kotlin_react.react.functionalComponent_7g4vsr$;
  ...
  function devOverrideUseRef(action) {
    ...
    if (process.env.NODE_ENV !== 'production') {
      ...
      $module$react.useRef = devOverrideUseRef$lambda;
      var result = action();
      $module$react.useRef = useRef;
      tmp$ = result;
    } else
      tmp$ = action();
    return tmp$;
  ...
  return _;
}(module.exports, require('kotlin'), require('kotlin-css'), require('kotlin-extensions'), require('inline-style-prefixer'), require('kotlin-react'), require('kotlin-react-dom'), require('styled-components'), require('react'), require('react-dom'), require('kotlinx-html-js')));
