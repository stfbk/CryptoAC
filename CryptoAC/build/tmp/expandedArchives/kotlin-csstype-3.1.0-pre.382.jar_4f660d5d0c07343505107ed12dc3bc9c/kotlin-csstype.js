(function (root, factory) {
  ...
  var Animation = defineInlineFunction('kotlin-csstype.csstype.Animation_di307g$', function (name, duration) {
    return name.toString() + ' ' + duration;
  });
  var Animation_0 = defineInlineFunction('kotlin-csstype.csstype.Animation_3k430r$', function (name, duration, timingFunction) {
    return name.toString() + ' ' + duration + ' ' + timingFunction;
  });
  var Animation_1 = defineInlineFunction('kotlin-csstype.csstype.Animation_edag2z$', function (name, duration, timingFunction, delay) {
    return name.toString() + ' ' + duration + ' ' + timingFunction + ' ' + delay;
  });
  ...
  var Font = defineInlineFunction('kotlin-csstype.csstype.Font_or47ys$', function (style, size, family) {
    return style.toString() + ' ' + size + ' ' + family;
  });
  var Font_0 = defineInlineFunction('kotlin-csstype.csstype.Font_rmisz8$', function (style, size, lineHeight, family) {
    return style.toString() + ' ' + size + '/' + lineHeight + ' ' + family;
  });
  var Font_1 = defineInlineFunction('kotlin-csstype.csstype.Font_ay5wdk$', function (variant, size, family) {
    return variant.toString() + ' ' + size + ' ' + family;
  });
  var Font_2 = defineInlineFunction('kotlin-csstype.csstype.Font_vd96w0$', function (variant, size, lineHeight, family) {
    return variant.toString() + ' ' + size + '/' + lineHeight + ' ' + family;
  });
  var Font_3 = defineInlineFunction('kotlin-csstype.csstype.Font_8czly3$', function (weight, size, family) {
    return weight.toString() + ' ' + size + ' ' + family;
  });
  var Font_4 = defineInlineFunction('kotlin-csstype.csstype.Font_7bd31v$', function (weight, size, lineHeight, family) {
    return weight.toString() + ' ' + size + '/' + lineHeight + ' ' + family;
  });
  var Font_5 = defineInlineFunction('kotlin-csstype.csstype.Font_xekjvs$', function (stretch, size, family) {
    return stretch.toString() + ' ' + size + ' ' + family;
  });
  var Font_6 = defineInlineFunction('kotlin-csstype.csstype.Font_d9efz4$', function (stretch, size, lineHeight, family) {
    return stretch.toString() + ' ' + size + '/' + lineHeight + ' ' + family;
  });
  var Font_7 = defineInlineFunction('kotlin-csstype.csstype.Font_etdi4t$', function (style, variant, size, family) {
    return style.toString() + ' ' + variant + ' ' + size + ' ' + family;
  });
  var Font_8 = defineInlineFunction('kotlin-csstype.csstype.Font_ibxa91$', function (style, variant, size, lineHeight, family) {
    return style.toString() + ' ' + variant + ' ' + size + '/' + lineHeight + ' ' + family;
  });
  var Font_9 = defineInlineFunction('kotlin-csstype.csstype.Font_m8ekpi$', function (style, weight, size, family) {
    return style.toString() + ' ' + weight + ' ' + size + ' ' + family;
  });
  var Font_10 = defineInlineFunction('kotlin-csstype.csstype.Font_29q582$', function (style, weight, size, lineHeight, family) {
    return style.toString() + ' ' + weight + ' ' + size + '/' + lineHeight + ' ' + family;
  });
  var Font_11 = defineInlineFunction('kotlin-csstype.csstype.Font_xrbwc3$', function (style, stretch, size, family) {
    return style.toString() + ' ' + stretch + ' ' + size + ' ' + family;
  });
  var Font_12 = defineInlineFunction('kotlin-csstype.csstype.Font_qaqcm3$', function (style, stretch, size, lineHeight, family) {
    return style.toString() + ' ' + stretch + ' ' + size + '/' + lineHeight + ' ' + family;
  });
  var Font_13 = defineInlineFunction('kotlin-csstype.csstype.Font_y9qmte$', function (variant, weight, size, family) {
    return variant.toString() + ' ' + weight + ' ' + size + ' ' + family;
  });
  var Font_14 = defineInlineFunction('kotlin-csstype.csstype.Font_hceqx2$', function (variant, weight, size, lineHeight, family) {
    return variant.toString() + ' ' + weight + ' ' + size + '/' + lineHeight + ' ' + family;
  });
  var Font_15 = defineInlineFunction('kotlin-csstype.csstype.Font_fricv3$', function (variant, stretch, size, family) {
    return variant.toString() + ' ' + stretch + ' ' + size + ' ' + family;
  });
  var Font_16 = defineInlineFunction('kotlin-csstype.csstype.Font_3lvcop$', function (variant, stretch, size, lineHeight, family) {
    return variant.toString() + ' ' + stretch + ' ' + size + '/' + lineHeight + ' ' + family;
  });
  var Font_17 = defineInlineFunction('kotlin-csstype.csstype.Font_jk0ec4$', function (weight, stretch, size, family) {
    return weight.toString() + ' ' + stretch + ' ' + size + ' ' + family;
  });
  var Font_18 = defineInlineFunction('kotlin-csstype.csstype.Font_5gw0lo$', function (weight, stretch, size, lineHeight, family) {
    return weight.toString() + ' ' + stretch + ' ' + size + '/' + lineHeight + ' ' + family;
  });
  var Font_19 = defineInlineFunction('kotlin-csstype.csstype.Font_nq1iir$', function (style, variant, weight, size, family) {
    return style.toString() + ' ' + variant + ' ' + weight + ' ' + size + ' ' + family;
  });
  var Font_20 = defineInlineFunction('kotlin-csstype.csstype.Font_15sh79$', function (style, variant, weight, size, lineHeight, family) {
    return style.toString() + ' ' + variant + ' ' + weight + ' ' + size + '/' + lineHeight + ' ' + family;
  });
  var Font_21 = defineInlineFunction('kotlin-csstype.csstype.Font_x86h1i$', function (style, variant, stretch, size, family) {
    return style.toString() + ' ' + variant + ' ' + stretch + ' ' + size + ' ' + family;
  });
  var Font_22 = defineInlineFunction('kotlin-csstype.csstype.Font_916wla$', function (style, variant, stretch, size, lineHeight, family) {
    return style.toString() + ' ' + variant + ' ' + stretch + ' ' + size + '/' + lineHeight + ' ' + family;
  });
  var Font_23 = defineInlineFunction('kotlin-csstype.csstype.Font_2oqlob$', function (variant, weight, stretch, size, family) {
    return variant.toString() + ' ' + weight + ' ' + stretch + ' ' + size + ' ' + family;
  });
  var Font_24 = defineInlineFunction('kotlin-csstype.csstype.Font_cvc74j$', function (variant, weight, stretch, size, lineHeight, family) {
    return variant.toString() + ' ' + weight + ' ' + stretch + ' ' + size + '/' + lineHeight + ' ' + family;
  });
  var Font_25 = defineInlineFunction('kotlin-csstype.csstype.Font_2qky8a$', function (style, variant, weight, stretch, size, family) {
    return style.toString() + ' ' + variant + ' ' + weight + ' ' + stretch + ' ' + size + ' ' + family;
  });
  var Font_26 = defineInlineFunction('kotlin-csstype.csstype.Font_jp1pxu$', function (style, variant, weight, stretch, size, lineHeight, family) {
    return style.toString() + ' ' + variant + ' ' + weight + ' ' + stretch + ' ' + size + '/' + lineHeight + ' ' + family;
  });
  ...
  var Transition = defineInlineFunction('kotlin-csstype.csstype.Transition_oil1ph$', function (property, duration, timingFunction) {
    return property.toString() + ' ' + duration + ' ' + timingFunction;
  });
  var Transition_0 = defineInlineFunction('kotlin-csstype.csstype.Transition_o5yvyd$', function (property, duration, delay) {
    return property.toString() + ' ' + duration + ' ' + delay;
  });
  var Transition_1 = defineInlineFunction('kotlin-csstype.csstype.Transition_38picb$', function (property, duration, timingFunction, delay) {
    return property.toString() + ' ' + duration + ' ' + timingFunction + ' ' + delay;
  });
  ...
  PropertiesBuilder.prototype.unaryPlus_vwetjg$ = defineInlineFunction('kotlin-csstype.csstype.PropertiesBuilder.unaryPlus_vwetjg$', wrapFunction(function () {
    var Object$Companion = Object;
    return function ($receiver) {
      Object$Companion.assign(this, $receiver);
    };
  }));
  ...
  package$csstype.Animation_di307g$ = Animation;
  package$csstype.Animation_3k430r$ = Animation_0;
  package$csstype.Animation_edag2z$ = Animation_1;
  ...
  package$csstype.Font_or47ys$ = Font;
  package$csstype.Font_rmisz8$ = Font_0;
  package$csstype.Font_ay5wdk$ = Font_1;
  package$csstype.Font_vd96w0$ = Font_2;
  package$csstype.Font_8czly3$ = Font_3;
  package$csstype.Font_7bd31v$ = Font_4;
  package$csstype.Font_xekjvs$ = Font_5;
  package$csstype.Font_d9efz4$ = Font_6;
  package$csstype.Font_etdi4t$ = Font_7;
  package$csstype.Font_ibxa91$ = Font_8;
  package$csstype.Font_m8ekpi$ = Font_9;
  package$csstype.Font_29q582$ = Font_10;
  package$csstype.Font_xrbwc3$ = Font_11;
  package$csstype.Font_qaqcm3$ = Font_12;
  package$csstype.Font_y9qmte$ = Font_13;
  package$csstype.Font_hceqx2$ = Font_14;
  package$csstype.Font_fricv3$ = Font_15;
  package$csstype.Font_3lvcop$ = Font_16;
  package$csstype.Font_jk0ec4$ = Font_17;
  package$csstype.Font_5gw0lo$ = Font_18;
  package$csstype.Font_nq1iir$ = Font_19;
  package$csstype.Font_15sh79$ = Font_20;
  package$csstype.Font_x86h1i$ = Font_21;
  package$csstype.Font_916wla$ = Font_22;
  package$csstype.Font_2oqlob$ = Font_23;
  package$csstype.Font_cvc74j$ = Font_24;
  package$csstype.Font_2qky8a$ = Font_25;
  package$csstype.Font_jp1pxu$ = Font_26;
  ...
  package$csstype.Transition_oil1ph$ = Transition;
  package$csstype.Transition_o5yvyd$ = Transition_0;
  package$csstype.Transition_38picb$ = Transition_1;
