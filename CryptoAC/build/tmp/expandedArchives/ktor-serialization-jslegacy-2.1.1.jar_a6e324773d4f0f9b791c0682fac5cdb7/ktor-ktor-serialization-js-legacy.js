(function (root, factory) {
  ...
  Coroutine$deserialize$lambda.$metadata$ = {
  ...
  Coroutine$deserialize$lambda_0.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  ...
  WebsocketContentConverter.prototype.serialize_36e71y$ = function (charset, typeInfo, value, continuation) {
    return this.serializeNullable_rh40qx$(charset, typeInfo, value, continuation);
  };
  WebsocketContentConverter.prototype.serializeNullable_rh40qx$ = function (charset, typeInfo, value, continuation) {
    return this.serialize_36e71y$(charset, typeInfo, ensureNotNull(value), continuation);
  };
  ...
  function serialize(T_0, isT, $receiver, value, charset, continuation) {
    ...
    tryGetType$break: do {
     ...
     while (false);
    return $receiver.serializeNullable_rh40qx$(charset, typeInfoImpl(tmp$_1, tmp$_0_0, tryGetType$result_0), value, continuation);
  }
  ...
  function Coroutine$deserialize_0(T_0_0, isT_0, $receiver_0, content_0, charset_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
  ...
  Coroutine$deserialize_0.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$deserialize_0.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$deserialize_0.prototype.constructor = Coroutine$deserialize_0;
  Coroutine$deserialize_0.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
  ...
  function deserialize_0(T_0_0, isT_0, $receiver_0, content_0, charset_0, continuation_0, suspended) {
    var instance = new Coroutine$deserialize_0(T_0_0, isT_0, $receiver_0, content_0, charset_0, continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
