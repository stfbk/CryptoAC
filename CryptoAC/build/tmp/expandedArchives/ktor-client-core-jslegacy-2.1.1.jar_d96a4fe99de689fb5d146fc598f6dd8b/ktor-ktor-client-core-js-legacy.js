(function (root, factory) {
  ...
  ValidateStatus.prototype = Object.create(Enum.prototype);
  ValidateStatus.prototype.constructor = ValidateStatus;
  ...
  Coroutine$bodyNullable_qi9ur9$.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
        ...
        switch (this.state_0) {
          case 0:
            ...
            tryGetType$break: do {
             ...
             while (false);
            this.state_0 = 2;
            this.result_0 = this.local$$receiver.bodyNullable_qi9ur9$(typeInfoImpl(tmp$_2, tmp$_0_1, tryGetType$result_0), this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
      ...
      try {
        switch (this.state_0) {
          case 0:
            var tmp$;
            this.state_0 = 2;
            this.result_0 = this.local$$receiver.call.bodyNullable_qi9ur9$(this.local$typeInfo, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  function CacheControl() {
    ...
    this.ONLY_IF_CACHED_8be2vx$ = new HeaderValue('only-if-cached');
  ...
  function Coroutine$HttpCache$Companion$install$lambda(closure$plugin_0, closure$scope_0, this$HttpCache$_0, $receiver_0, content_0, controller, continuation_0) {
    ...
    this.local$cachedCall = void 0;
    this.local$validateStatus = void 0;
    this.local$$receiver = $receiver_0;
    this.local$content = content_0;
  }
    ...
    do
      try {
        switch (this.state_0) {
          ...
          case 3:
            this.local$cache = this.local$closure$plugin.findResponse_0(this.local$$receiver.context, this.local$content);
            if (this.local$cache == null) {
              var header_0 = parseHeaderValue(this.local$$receiver.context.headers.get_61zpoe$(http.HttpHeaders.CacheControl));
              if (header_0.contains_11rb$(CacheControl_getInstance().ONLY_IF_CACHED_8be2vx$)) {
                this.state_0 = 4;
                this.result_0 = this.local$this$HttpCache$.proceedWithMissingCache_0(this.local$$receiver, this.local$closure$scope, this);
                if (this.result_0 === COROUTINE_SUSPENDED)
                  return COROUTINE_SUSPENDED;
                continue;
              } else {
          ...
          case 5:
            return;
          case 6:
            this.local$cachedCall = this.local$cache.produceResponse_8be2vx$().call;
            this.local$validateStatus = shouldValidate(this.local$cache, this.local$$receiver.context);
            if (this.local$validateStatus === ValidateStatus$ShouldNotValidate_getInstance()) {
              this.state_0 = 7;
              this.result_0 = this.local$this$HttpCache$.proceedWithCache_0(this.local$$receiver, this.local$closure$scope, this.local$cachedCall, this);
              if (this.result_0 === COROUTINE_SUSPENDED)
                return COROUTINE_SUSPENDED;
              continue;
            } else {
          ...
          case 7:
            return;
          case 8:
            if (this.local$validateStatus === ValidateStatus$ShouldWarn_getInstance()) {
              this.state_0 = 9;
              this.result_0 = this.local$this$HttpCache$.proceedWithWarning_0(this.local$$receiver, this.local$cachedCall, this.local$closure$scope, this);
              if (this.result_0 === COROUTINE_SUSPENDED)
                return COROUTINE_SUSPENDED;
              continue;
            } else {
  ...
  function Coroutine$proceedWithCache_0($this, $receiver_0, scope_0, cachedCall_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.$this = $this;
    this.local$$receiver = $receiver_0;
    this.local$scope = scope_0;
    this.local$cachedCall = cachedCall_0;
  }
  Coroutine$proceedWithCache_0.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$proceedWithCache_0.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$proceedWithCache_0.prototype.constructor = Coroutine$proceedWithCache_0;
  Coroutine$proceedWithCache_0.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            this.local$$receiver.finish();
            this.local$scope.monitor.raise_asioqi$(this.$this.HttpResponseFromCache, this.local$cachedCall.response);
            this.state_0 = 2;
            this.result_0 = this.local$$receiver.proceedWith_trkh7z$(this.local$cachedCall, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  HttpCache$Companion.prototype.proceedWithCache_0 = function ($receiver_0, scope_0, cachedCall_0, continuation_0, suspended) {
    var instance = new Coroutine$proceedWithCache_0(this, $receiver_0, scope_0, cachedCall_0, continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  };
  function Coroutine$proceedWithWarning_0($this, $receiver_0, cachedCall_0, scope_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.$this = $this;
    this.local$$receiver = $receiver_0;
  ...
  Coroutine$proceedWithWarning_0.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$proceedWithWarning_0.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$proceedWithWarning_0.prototype.constructor = Coroutine$proceedWithWarning_0;
  Coroutine$proceedWithWarning_0.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            var request = this.local$$receiver.context.build();
            var tmp$ = this.local$cachedCall.response.status;
            var tmp$_0 = this.local$cachedCall.response.requestTime;
            var $receiver = new HeadersBuilder();
            $receiver.appendAll_hb0ubp$(this.local$cachedCall.response.headers);
            $receiver.append_puj7f4$(http.HttpHeaders.Warning, '110');
            var response = new HttpResponseData(tmp$, tmp$_0, $receiver.build(), this.local$cachedCall.response.version, this.local$cachedCall.response.content, this.local$cachedCall.response.coroutineContext);
            var call = HttpClientCall_init(this.local$scope, request, response);
            this.local$$receiver.finish();
            this.local$scope.monitor.raise_asioqi$(this.$this.HttpResponseFromCache, call.response);
            this.state_0 = 2;
            this.result_0 = this.local$$receiver.proceedWith_trkh7z$(call, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
  ...
  HttpCache$Companion.prototype.proceedWithWarning_0 = function ($receiver_0, cachedCall_0, scope_0, continuation_0, suspended) {
    var instance = new Coroutine$proceedWithWarning_0(this, $receiver_0, cachedCall_0, scope_0, continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  };
  function Coroutine$proceedWithMissingCache_0($this, $receiver_0, scope_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.$this = $this;
    this.local$$receiver = $receiver_0;
  ...
  Coroutine$proceedWithMissingCache_0.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$proceedWithMissingCache_0.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$proceedWithMissingCache_0.prototype.constructor = Coroutine$proceedWithMissingCache_0;
  Coroutine$proceedWithMissingCache_0.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            this.local$$receiver.finish();
            var request = this.local$$receiver.context.build();
            var response = new HttpResponseData(HttpStatusCode.Companion.GatewayTimeout, GMTDate(), Headers.Companion.Empty, HttpProtocolVersion.Companion.HTTP_1_1, ByteReadChannel_0(new Int8Array(0)), request.executionContext);
            var call = HttpClientCall_init(this.local$scope, request, response);
            this.state_0 = 2;
            this.result_0 = this.local$$receiver.proceedWith_trkh7z$(call, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
  ...
  HttpCache$Companion.prototype.proceedWithMissingCache_0 = function ($receiver_0, scope_0, continuation_0, suspended) {
    var instance = new Coroutine$proceedWithMissingCache_0(this, $receiver_0, scope_0, continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  ...
  function shouldValidate($receiver, request) {
    var tmp$, tmp$_0, tmp$_1, tmp$_2;
    var cacheControl = parseHeaderValue($receiver.responseHeaders_8be2vx$.get_61zpoe$(http.HttpHeaders.CacheControl));
    var validMillis = $receiver.expires.timestamp.subtract(getTimeMillis());
    if (cacheControl.contains_11rb$(CacheControl_getInstance().NO_CACHE_8be2vx$))
      return ValidateStatus$ShouldValidate_getInstance();
    if (validMillis.toNumber() > 0)
      return ValidateStatus$ShouldNotValidate_getInstance();
    if (cacheControl.contains_11rb$(CacheControl_getInstance().MUST_REVALIDATE_8be2vx$))
      return ValidateStatus$ShouldValidate_getInstance();
    var requestCacheControl = parseHeaderValue(request.headers.get_61zpoe$(http.HttpHeaders.CacheControl));
    var firstOrNull$result;
    firstOrNull$break: do {
      var tmp$_3;
      tmp$_3 = requestCacheControl.iterator();
      while (tmp$_3.hasNext()) {
        var element = tmp$_3.next();
        if (startsWith(element.value, 'max-stale=')) {
          firstOrNull$result = element;
          break firstOrNull$break;
        }
      }
     ...
     while (false);
    var maxStale = (tmp$_2 = (tmp$_1 = (tmp$_0 = (tmp$ = firstOrNull$result) != null ? tmp$.value : null) != null ? tmp$_0.substring(10) : null) != null ? toIntOrNull(tmp$_1) : null) != null ? tmp$_2 : 0;
    var maxStaleMillis = Kotlin.Long.fromInt(maxStale).multiply(L1000);
    if (validMillis.add(maxStaleMillis).toNumber() > 0)
      return ValidateStatus$ShouldWarn_getInstance();
    return ValidateStatus$ShouldValidate_getInstance();
  }
  function ValidateStatus(name, ordinal) {
    Enum.call(this);
    this.name$ = name;
    this.ordinal$ = ordinal;
  }
  function ValidateStatus_initFields() {
    ValidateStatus_initFields = function () {
    };
    ValidateStatus$ShouldValidate_instance = new ValidateStatus('ShouldValidate', 0);
    ValidateStatus$ShouldNotValidate_instance = new ValidateStatus('ShouldNotValidate', 1);
    ValidateStatus$ShouldWarn_instance = new ValidateStatus('ShouldWarn', 2);
  }
  var ValidateStatus$ShouldValidate_instance;
  function ValidateStatus$ShouldValidate_getInstance() {
    ValidateStatus_initFields();
    return ValidateStatus$ShouldValidate_instance;
  }
  var ValidateStatus$ShouldNotValidate_instance;
  function ValidateStatus$ShouldNotValidate_getInstance() {
    ValidateStatus_initFields();
    return ValidateStatus$ShouldNotValidate_instance;
  }
  var ValidateStatus$ShouldWarn_instance;
  function ValidateStatus$ShouldWarn_getInstance() {
    ValidateStatus_initFields();
    return ValidateStatus$ShouldWarn_instance;
  }
  ValidateStatus.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'ValidateStatus',
    interfaces: [Enum]
  };
  function ValidateStatus$values() {
    return [ValidateStatus$ShouldValidate_getInstance(), ValidateStatus$ShouldNotValidate_getInstance(), ValidateStatus$ShouldWarn_getInstance()];
  }
  ValidateStatus.values = ValidateStatus$values;
  function ValidateStatus$valueOf(name) {
    switch (name) {
      case 'ShouldValidate':
        return ValidateStatus$ShouldValidate_getInstance();
      case 'ShouldNotValidate':
        return ValidateStatus$ShouldNotValidate_getInstance();
      case 'ShouldWarn':
        return ValidateStatus$ShouldWarn_getInstance();
      default:
        throwISE('No enum constant io.ktor.client.plugins.cache.ValidateStatus.' + name);
    }
  }
  ValidateStatus.valueOf_61zpoe$ = ValidateStatus$valueOf;
        ...
        switch (this.state_0) {
          case 0:
            ...
            tryGetType$break: do {
             ...
             while (false);
            this.state_0 = 2;
            this.result_0 = converter_0.serializeNullable_rh40qx$(charset_0, typeInfoImpl_0(tmp$_1_0, tmp$_0_0_0, tryGetType$result_0_0), this.local$data, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
    ...
    do
      try {
        switch (this.state_0) {
          case 0:
            var tmp$_3, tmp$_4;
            tmp$_3 = get_converter(this.local$$receiver);
            if (tmp$_3 == null) {
              throw new WebsocketConverterNotFoundException('No converter was found for websocket');
            }

            this.local$converter = tmp$_3;
          ...
          case 3:
            ...
            var tmp$_2_0 = reflect_0.JsType;
            var tmp$_0_1_0 = getKClass(this.local$T_0);
            var tryGetType$result_0_0;
            tryGetType$break: do {
              try {
                tryGetType$result_0_0 = getReifiedTypeParameterKType(this.local$T_0);
             ...
             while (false);
            this.local$typeInfo = typeInfoImpl_0(tmp$_2_0, tmp$_0_1_0, tryGetType$result_0_0);
            this.state_0 = 4;
            this.result_0 = this.local$converter.deserialize_v0czzf$(this.local$charset, this.local$typeInfo, this.local$frame, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 4:
          ...
          case 5:
            if (this.local$result == null) {
              if (((tmp$_1_0 = this.local$typeInfo.kotlinType) != null ? tmp$_1_0.isMarkedNullable : null) === true) {
                this.result_0 = null;
                this.state_0 = 8;
                continue;
              } else {
          ...
          case 6:
            throw new WebsocketDeserializeException_init('Frame has null content', void 0, this.local$frame);
          case 7:
          ...
          case 8:
            return this.local$isT(tmp$_4 = this.result_0) ? tmp$_4 : throwCCE();
          default:
            this.state_0 = 1;
            throw new Error('State Machine Unreachable execution');
        }
  ...
  function setBody_0($receiver, body, bodyType) {
    $receiver.body = body != null ? body : content.NullBody;
    $receiver.bodyType = bodyType;
  }
      ...
      return function ($receiver) {
        if (closure$encodeInQuery) {
          ...
          if (body == null) {
            ...
            $receiver.body = body;
            var tmp$_1 = reflect.JsType;
            var tmp$_0_0 = getKClass_0(FormDataContent);
            var tryGetType$result_0;
            tryGetType$break: do {
              try {
    ...
    return function (closure$formData, closure$block) {
      return function ($receiver) {
        ...
        if (body == null) {
          ...
          $receiver.body = body;
          var tmp$_1 = reflect.JsType;
          var tmp$_0_0 = getKClass_0(MultiPartFormDataContent);
          var tryGetType$result_0;
          tryGetType$break: do {
            try {
  ...
  function submitForm($receiver, formParameters, encodeInQuery, block, continuation) {
    ...
    if (encodeInQuery) {
      ...
      if (body_0 == null) {
        ...
        var tmp$_2 = reflect.JsType;
        var tmp$_0_1 = getKClass(FormDataContent);
        var tryGetType$result_1;
        tryGetType$break: do {
          try {
            tryGetType$result_1 = createKType(getKClass(FormDataContent), [], false);
          } catch (cause_1) {
        ...
        var tmp$_0_2 = getKClass(FormDataContent);
        var tryGetType$result_2;
        tryGetType$break: do {
          try {
            tryGetType$result_2 = createKType(getKClass(FormDataContent), [], false);
          } catch (cause_2) {
  ...
  function submitForm_0($receiver, url, formParameters, encodeInQuery, block, continuation) {
    ...
    if (encodeInQuery) {
      ...
      if (body == null) {
        $receiver_0.body = content.NullBody;
        var tmp$ = reflect.JsType;
        ...
        tryGetType$break: do {
         ...
         while (false);
        $receiver_0.bodyType = typeInfoImpl(tmp$_1, tmp$_0_0, tryGetType$result_0);
      }
    }
  ...
  function submitFormWithBinaryData($receiver, formData, block, continuation) {
    ...
    if (body_0 == null) {
      $receiver_1.body = content.NullBody;
      var tmp$_2 = reflect.JsType;
      var tmp$_0_1 = getKClass(MultiPartFormDataContent);
      var tryGetType$result_1;
      tryGetType$break: do {
        try {
          tryGetType$result_1 = createKType(getKClass(MultiPartFormDataContent), [], false);
        } catch (cause_1) {
          if (Kotlin.isType(cause_1, Throwable)) {
            tryGetType$result_1 = null;
            break tryGetType$break;
      ...
      $receiver_1.body = body_0;
      var tmp$_3 = reflect.JsType;
      var tmp$_0_2 = getKClass(MultiPartFormDataContent);
      var tryGetType$result_2;
      tryGetType$break: do {
        try {
          tryGetType$result_2 = createKType(getKClass(MultiPartFormDataContent), [], false);
        } catch (cause_2) {
          if (Kotlin.isType(cause_2, Throwable)) {
            tryGetType$result_2 = null;
            break tryGetType$break;
  ...
  package$cache.shouldValidate_nphaaz$ = shouldValidate;
  Object.defineProperty(ValidateStatus, 'ShouldValidate', {
    get: ValidateStatus$ShouldValidate_getInstance
  });
  Object.defineProperty(ValidateStatus, 'ShouldNotValidate', {
    get: ValidateStatus$ShouldNotValidate_getInstance
  });
  Object.defineProperty(ValidateStatus, 'ShouldWarn', {
    get: ValidateStatus$ShouldWarn_getInstance
  });
  package$cache.ValidateStatus = ValidateStatus;
  ...
  package$request.setBody_fxezhw$ = setBody_0;
