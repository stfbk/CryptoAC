(function (root, factory) {
  ...
  function JsonPlugin(serializer, acceptContentTypes, receiveContentTypeMatchers, ignoredTypes) {
    ...
    if (ignoredTypes === void 0)
      ignoredTypes = plus(DefaultCommonIgnoredTypes, DefaultIgnoredTypes);
    this.serializer = serializer;
    this.acceptContentTypes = acceptContentTypes;
    this.receiveContentTypeMatchers_0 = receiveContentTypeMatchers;
    this.ignoredTypes_0 = ignoredTypes;
  }
  ...
  JsonPlugin$Config.prototype.ignoreType_287e2$ = defineInlineFunction('ktor-ktor-client-json-js-legacy.io.ktor.client.plugins.json.JsonPlugin.Config.ignoreType_287e2$', wrapFunction(function () {
    var getKClass = Kotlin.getKClass;
    return function (T_0, isT) {
      this.ignoreType_xo1ogr$(getKClass(T_0));
    };
  }));
  JsonPlugin$Config.prototype.removeIgnoredType_287e2$ = defineInlineFunction('ktor-ktor-client-json-js-legacy.io.ktor.client.plugins.json.JsonPlugin.Config.removeIgnoredType_287e2$', wrapFunction(function () {
    var getKClass = Kotlin.getKClass;
    return function (T_0, isT) {
      this.removeIgnoredType_xo1ogr$(getKClass(T_0));
    };
  }));
  JsonPlugin$Config.prototype.removeIgnoredType_xo1ogr$ = function (type) {
    this.ignoredTypes_8be2vx$.remove_11rb$(type);
  };
  JsonPlugin$Config.prototype.ignoreType_xo1ogr$ = function (type) {
    this.ignoredTypes_8be2vx$.add_11rb$(type);
  };
  JsonPlugin$Config.prototype.clearIgnoredTypes = function () {
  ...
  JsonPlugin$Plugin.prototype.prepare_oh3mgy$$default = function (block) {
    ...
    var ignoredTypes = config.ignoredTypes_8be2vx$;
      ...
      try {
        switch (this.state_0) {
          case 0:
            ...
            if (this.local$closure$plugin.ignoredTypes_0.contains_11rb$(Kotlin.getKClassFromExpression(this.local$payload))) {
              return;
            } else {
              this.state_0 = 2;
              continue;
      ...
      try {
        switch (this.state_0) {
          ...
          case 1:
            throw this.exception_0;
          case 2:
            if (this.local$closure$plugin.ignoredTypes_0.contains_11rb$(this.local$info.type)) {
              return;
            } else {
              this.state_0 = 3;
              continue;
  ...
  Object.defineProperty(package$json, 'DefaultCommonIgnoredTypes_8be2vx$', {
    get: function () {
  ...
  Object.defineProperty(package$json, 'DefaultIgnoredTypes_8be2vx$', {
    get: function () {
