(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    ...
    if (typeof kotlin === 'undefined') {
      throw new Error("Error loading module 'kotlin-logging-jsLegacy'. Its dependency 'kotlin' was not found. Please, check whether 'kotlin' is loaded prior to 'kotlin-logging-jsLegacy'.");
    }root['kotlin-logging-jsLegacy'] = factory(typeof this['kotlin-logging-jsLegacy'] === 'undefined' ? {} : this['kotlin-logging-jsLegacy'], kotlin);
  }
  ...
  var toStringSafe = defineInlineFunction('kotlin-logging-jsLegacy.mu.internal.toStringSafe_qhgloa$', wrapFunction(function () {
    var toString = Kotlin.toString;
    var internal = _.mu.internal;
    var Exception = Kotlin.kotlin.Exception;
    return function ($receiver) {
      ...
      try {
        ...
        if (Kotlin.isType(e, Exception)) {
          tmp$ = internal.ErrorMessageProducer.getErrorLog_3lhtaa$(e);
        } else
          throw e;
      }
      return tmp$;
  ...
  ErrorMessageProducer.$metadata$ = {
    kind: Kind_OBJECT,
    simpleName: 'ErrorMessageProducer',
    interfaces: []
  };
  ...
  $$importsForInline$$['kotlin-logging-jsLegacy'] = _;
  ...
  Object.defineProperty(package$internal, 'ErrorMessageProducer', {
    get: ErrorMessageProducer_getInstance
  });
  package$internal.KLoggerJS = KLoggerJS;
  package$internal.MarkerJS = MarkerJS;
  Kotlin.defineModule('kotlin-logging-jsLegacy', _);
  return _;
}));

//# sourceMappingURL=kotlin-logging-jsLegacy.js.map
