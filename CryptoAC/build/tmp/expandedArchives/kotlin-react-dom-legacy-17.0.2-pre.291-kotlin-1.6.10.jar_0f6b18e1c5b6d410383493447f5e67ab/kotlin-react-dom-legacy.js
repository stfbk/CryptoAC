(function (root, factory) {
  ...
  function createPortal_0(container, handler) {
    return createPortal(ensureNotNull(createElement_0(handler)), container);
  }
  ...
  function renderIntoRoot(container, block) {
    var tmp$;
    tmp$ = createElement_0(block);
    if (tmp$ == null) {
      return;
    }var children = tmp$;
  ...
  package$dom.renderIntoRoot_upx1ym$ = renderIntoRoot;
