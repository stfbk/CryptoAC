(function (root, factory) {
  ...
  function inlineStyles($receiver, prefix, preserveExisting, builder) {
    if (prefix === void 0)
      prefix = true;
    if (preserveExisting === void 0)
      preserveExisting = false;
    var $receiver_0 = StyledElement();
    builder($receiver_0);
    var newStyle = toStyle($receiver_0, prefix);
    if (preserveExisting) {
      var existingStyle = Object.assign({}, $receiver.get_g0n3bx$($receiver.attrs, 'style'));
      var style = Object.assign(existingStyle, newStyle);
      setProp($receiver, 'style', style);
    } else {
      setProp($receiver, 'style', newStyle);
    }
  }
  ...
  function keyframesName(string) {
    var keyframes = invoke_0($module$styled_components.keyframes, string, []);
    var keyframesInternal = invoke_1($module$styled_components.css, [keyframes.rules]);
  ...
  function injectGlobals$lambda(closure$strings) {
    return function () {
      return invoke($module$styled_components.createGlobalStyle, closure$strings, []);
    };
  }
  ...
  function injectGlobal$lambda(closure$string) {
    return function () {
      return invoke_0($module$styled_components.createGlobalStyle, closure$string, []);
    };
  }
  ...
  package$styled.inlineStyles_jgm4m1$ = inlineStyles;
  ...
  package$styled.invoke_u1luq3$ = invoke_0;
