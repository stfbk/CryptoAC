        ...
        switch (this.state_0) {
          case 0:
            ...
            tryGetType$break: do {
             ...
             while (false);
            this.state_0 = 2;
            this.result_0 = this.local$converter.serializeNullable_rh40qx$(this.local$charset, typeInfoImpl(tmp$_1, tmp$_0_0, tryGetType$result_0), this.local$data, this);
        ...
        switch (this.state_0) {
          ...
          case 2:
            ...
            tryGetType$break: do {
             ...
             while (false);
            this.local$typeInfo = typeInfoImpl(tmp$_2, tmp$_0_1, tryGetType$result_0);
            this.state_0 = 3;
          ...
          case 4:
            if (this.local$result == null) {
              if (((tmp$_1 = this.local$typeInfo.kotlinType) != null ? tmp$_1.isMarkedNullable : null) === true) {
                return null;
              } else {
                this.state_0 = 5;
                continue;
          ...
          case 5:
            throw new WebsocketDeserializeException('Frame has null content', void 0, this.local$frame);
          case 6:
