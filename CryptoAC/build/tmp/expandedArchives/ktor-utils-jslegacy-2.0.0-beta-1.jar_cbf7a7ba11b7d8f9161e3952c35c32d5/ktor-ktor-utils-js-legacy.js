(function(root, factory) {
  ...
  function StringValuesImpl(caseInsensitiveName, values) {
    ...
    this.values = null;
    var newMap = this.caseInsensitiveName ? caseInsensitiveMap() : LinkedHashMap_init_0();
    var tmp$;
  ...
  function StringValuesBuilderImpl(caseInsensitiveName, size) {
    ...
    this.values = this.caseInsensitiveName ? caseInsensitiveMap() : sharedMap(size);
  }
  ...
  function sharedListOf(values) {
    if (PlatformUtils_getInstance().IS_NATIVE && !PlatformUtils_getInstance().IS_NEW_MM_ENABLED) {
  ...
  function sharedMap(initialCapacity) {
    if (initialCapacity === void 0) 
      initialCapacity = 8;
    if (PlatformUtils_getInstance().IS_NATIVE && !PlatformUtils_getInstance().IS_NEW_MM_ENABLED) {
      return new ConcurrentMap(void 0, initialCapacity);
    }
    return LinkedHashMap_init_0();
  }
  function sharedList() {
    if (PlatformUtils_getInstance().IS_NATIVE && !PlatformUtils_getInstance().IS_NEW_MM_ENABLED) {
  ...
  function DataConversion$Configuration() {
    this.converters_8be2vx$ = LinkedHashMap_init_0();
  }
  ...
  var package$internal_0 = package$util.internal || (package$util.internal = {});
  Object.defineProperty(package$internal_0, 'UNDECIDED', {
  get: function() {
  return UNDECIDED;
}});
  Object.defineProperty(package$internal_0, 'SUCCESS', {
  get: function() {
  return SUCCESS;
}});
  Object.defineProperty(package$internal_0, 'FAILURE', {
  get: function() {
  return FAILURE;
}});
  Object.defineProperty(package$internal_0, 'CONDITION_FALSE', {
  get: function() {
  return CONDITION_FALSE;
}});
  Object.defineProperty(package$internal_0, 'ALREADY_REMOVED', {
  get: function() {
  return ALREADY_REMOVED;
}});
  Object.defineProperty(package$internal_0, 'LIST_EMPTY', {
  get: function() {
  return LIST_EMPTY;
}});
  ...
  package$internal_0.LockFreeLinkedListNode = LockFreeLinkedListNode;
  ...
  package$internal_0.unwrap_s8jyvk$ = unwrap;
  package$internal_0.LockFreeLinkedListHead = LockFreeLinkedListHead;
