(function (root, factory) {
  ...
  var Grouping = kotlin_kotlin.$_$.d5;
  var IllegalArgumentException_init_$Create$ = kotlin_kotlin.$_$.s1;
  var zip = kotlin_kotlin.$_$.d9;
  ...
  var Iterator = kotlin_kotlin.$_$.h5;
  var Iterable = kotlin_kotlin.$_$.g5;
  ...
  var withIndex = kotlin_kotlin.$_$.c9;
  ...
  var indexOf = kotlin_kotlin.$_$.i7;
  var contentToString = kotlin_kotlin.$_$.g6;
  ...
  var contentHashCode = kotlin_kotlin.$_$.f6;
  ...
  var isLongArray = kotlin_kotlin.$_$.fb;
  var Companion_getInstance_2 = kotlin_kotlin.$_$.y4;
  var _ULongArray___get_size__impl__ju6dtr = kotlin_kotlin.$_$.v3;
  ...
  var _UIntArray___get_size__impl__r6l8ci = kotlin_kotlin.$_$.m3;
  var UIntArray = kotlin_kotlin.$_$.kg;
  var _UIntArray___init__impl__ghjpc6 = kotlin_kotlin.$_$.i3;
  var _UInt___init__impl__l7qpdl = kotlin_kotlin.$_$.f3;
  var UIntArray__get_impl_gp5kza = kotlin_kotlin.$_$.k3;
  ...
  var _UByteArray___get_size__impl__h6pkdv = kotlin_kotlin.$_$.d3;
  var UByteArray = kotlin_kotlin.$_$.ig;
  var _UByteArray___init__impl__ip4y9n = kotlin_kotlin.$_$.a3;
  var _UByte___init__impl__g9hnc4 = kotlin_kotlin.$_$.w2;
  var UByteArray__get_impl_t5f3hv = kotlin_kotlin.$_$.b3;
  ...
  var _ULongArray___get_storage__impl__28e64j = kotlin_kotlin.$_$.w3;
  var _ULongArray___init__impl__twm1l3_0 = kotlin_kotlin.$_$.s3;
  var ULongArray__set_impl_z19mvh = kotlin_kotlin.$_$.u3;
  var copyOf_3 = kotlin_kotlin.$_$.q6;
  var _UIntArray___get_storage__impl__92a0v0 = kotlin_kotlin.$_$.n3;
  var _UIntArray___init__impl__ghjpc6_0 = kotlin_kotlin.$_$.j3;
  var UIntArray__set_impl_7f2zu2 = kotlin_kotlin.$_$.l3;
  ...
  var _UByteArray___get_storage__impl__d4kctt = kotlin_kotlin.$_$.e3;
  var _UByteArray___init__impl__ip4y9n_0 = kotlin_kotlin.$_$.z2;
  var UByteArray__set_impl_jvcicn = kotlin_kotlin.$_$.c3;
  var copyOf_6 = kotlin_kotlin.$_$.k6;
  var trimIndent = kotlin_kotlin.$_$.gf;
  ...
  function PolymorphicSerializer$descriptor$delegate$lambda$lambda(this$0) {
    return function ($this$buildSerialDescriptor) {
      $this$buildSerialDescriptor.element$default_r6n2dg_k$('type', serializer_7(StringCompanionObject_getInstance()).get_descriptor_wjt6a0_k$());
  ...
  function createUnmarkedDescriptor($this, serialName) {
    ...
    while (inductionVariable < last) {
      ...
      d.addElement$default_fcc4uw_k$(element.get_name_woqyms_k$());
    }
    return d;
  }
  ...
  protoOf(EnumSerializer).serialize_32qylj_k$ = function (encoder, value) {
  ...
  protoOf(EnumSerializer).deserialize_2t41fm_k$ = function (decoder) {
  ...
  function DoubleArraySerializer_0() {
    ...
    PrimitiveArraySerializer.call(this, serializer_12(DoubleCompanionObject_getInstance()));
  }
  ...
  function FloatArraySerializer_0() {
    ...
    PrimitiveArraySerializer.call(this, serializer_13(FloatCompanionObject_getInstance()));
  }
  ...
  function ShortArraySerializer_0() {
    ...
    PrimitiveArraySerializer.call(this, serializer_4(ShortCompanionObject_getInstance()));
  }
  ...
  function ByteArraySerializer_0() {
    ...
    PrimitiveArraySerializer.call(this, serializer_2(ByteCompanionObject_getInstance()));
  }
  ...
  function _init_properties_Primitives_kt__k0eto4() {
    if (properties_initialized_Primitives_kt_6dpii6) {
      ...
      BUILTIN_SERIALIZERS = mapOf([to(PrimitiveClasses_getInstance().get_stringClass_bik2gy_k$(), serializer_7(StringCompanionObject_getInstance())), to(getKClass(Char), serializer_11(Companion_getInstance_1())), to(PrimitiveClasses_getInstance().get_charArrayClass_7lhfoe_k$(), CharArraySerializer()), to(PrimitiveClasses_getInstance().get_doubleClass_dahzcy_k$(), serializer_12(DoubleCompanionObject_getInstance())), to(PrimitiveClasses_getInstance().get_doubleArrayClass_84hee1_k$(), DoubleArraySerializer()), to(PrimitiveClasses_getInstance().get_floatClass_xlwq2t_k$(), serializer_13(FloatCompanionObject_getInstance())), to(PrimitiveClasses_getInstance().get_floatArrayClass_qngmha_k$(), FloatArraySerializer()), to(getKClass(Long), serializer_5(Companion_getInstance_0())), to(PrimitiveClasses_getInstance().get_longArrayClass_v379a4_k$(), LongArraySerializer()), to(getKClass(ULong), serializer_10(Companion_getInstance_2())), to(getKClass(ULongArray), ULongArraySerializer()), to(PrimitiveClasses_getInstance().get_intClass_mw4y9a_k$(), serializer_6(IntCompanionObject_getInstance())), to(PrimitiveClasses_getInstance().get_intArrayClass_h44pbv_k$(), IntArraySerializer()), to(getKClass(UInt), serializer_3(Companion_getInstance_3())), to(getKClass(UIntArray), UIntArraySerializer()), to(PrimitiveClasses_getInstance().get_shortClass_5ajsv9_k$(), serializer_4(ShortCompanionObject_getInstance())), to(PrimitiveClasses_getInstance().get_shortArrayClass_c1p7wy_k$(), ShortArraySerializer()), to(getKClass(UShort), serializer_9(Companion_getInstance_4())), to(getKClass(UShortArray), UShortArraySerializer()), to(PrimitiveClasses_getInstance().get_byteClass_pu7s61_k$(), serializer_2(ByteCompanionObject_getInstance())), to(PrimitiveClasses_getInstance().get_byteArrayClass_57my8g_k$(), ByteArraySerializer()), to(getKClass(UByte), serializer_8(Companion_getInstance_5())), to(getKClass(UByteArray), UByteArraySerializer()), to(PrimitiveClasses_getInstance().get_booleanClass_d285fr_k$(), serializer_14(BooleanCompanionObject_getInstance())), to(PrimitiveClasses_getInstance().get_booleanArrayClass_lnbwea_k$(), BooleanArraySerializer()), to(getKClass(Unit), serializer_15(Unit_getInstance())), to(PrimitiveClasses_getInstance().get_nothingClass_7ivpcc_k$(), NothingSerializer()), to(getKClass(Duration), serializer_16(Companion_getInstance()))]);
    }
  }
  ...
  function UShortSerializer() {
    ...
    this.descriptor_1 = InlinePrimitiveDescriptor('kotlin.UShort', serializer_4(ShortCompanionObject_getInstance()));
  }
  ...
  function UByteSerializer() {
    ...
    this.descriptor_1 = InlinePrimitiveDescriptor('kotlin.UByte', serializer_2(ByteCompanionObject_getInstance()));
  }
  ...
  protoOf(PolymorphicModuleBuilder).set_defaultSerializerProvider_hup0gh_k$ = function (_set____db54di) {
  ...
  protoOf(PolymorphicModuleBuilder).set_defaultDeserializerProvider_4rhijj_k$ = function (_set____db54di) {
  ...
  protoOf(PolymorphicModuleBuilder).subclass_tslaf9_k$ = function (subclass, serializer) {
    this.subclasses_1.add_1j60pz_k$(to(subclass, serializer));
  };
  protoOf(PolymorphicModuleBuilder).defaultDeserializer_hjjg64_k$ = function (defaultDeserializerProvider) {
    // Inline function 'kotlin.require' call
  ...
  protoOf(PolymorphicModuleBuilder).default_5nodv5_k$ = function (defaultSerializerProvider) {
    this.defaultDeserializer_hjjg64_k$(defaultSerializerProvider);
  };
  protoOf(PolymorphicModuleBuilder).buildTo_ivxld_k$ = function (builder) {
    if (!(this.baseSerializer_1 == null)) {
      builder.registerPolymorphicSerializer$default_x4uag2_k$(this.baseClass_1, this.baseClass_1, this.baseSerializer_1);
    }
    // Inline function 'kotlin.collections.forEach' call
    ...
    while (tmp0_iterator.hasNext_bitz1p_k$()) {
      ...
      builder.registerPolymorphicSerializer$default_x4uag2_k$(this.baseClass_1, tmp, tmp$ret$0);
    }
    ...
    if (!(defaultDeserializer == null)) {
      builder.registerDefaultPolymorphicDeserializer_vvbkk4_k$(this.baseClass_1, defaultDeserializer, false);
    }
  };
  ...
  protoOf(SerializersModuleBuilder).contextual_ki5uma_k$ = function (kClass, serializer) {
    return this.registerSerializer$default_qp6un6_k$(kClass, new Argless(serializer));
  };
  protoOf(SerializersModuleBuilder).contextual_oi2m58_k$ = function (kClass, provider) {
    return this.registerSerializer$default_qp6un6_k$(kClass, new WithTypeArguments(provider));
  };
  protoOf(SerializersModuleBuilder).polymorphic_sbh4xj_k$ = function (baseClass, actualClass, actualSerializer) {
    this.registerPolymorphicSerializer$default_x4uag2_k$(baseClass, actualClass, actualSerializer);
  };
  protoOf(SerializersModuleBuilder).polymorphicDefaultSerializer_g5ty2r_k$ = function (baseClass, defaultSerializerProvider) {
    this.registerDefaultPolymorphicSerializer_5i0b4y_k$(baseClass, defaultSerializerProvider, false);
  };
  protoOf(SerializersModuleBuilder).polymorphicDefaultDeserializer_vtblm7_k$ = function (baseClass, defaultDeserializerProvider) {
    this.registerDefaultPolymorphicDeserializer_vvbkk4_k$(baseClass, defaultDeserializerProvider, false);
  };
  protoOf(SerializersModuleBuilder).include_if2r2v_k$ = function (module_0) {
    module_0.dumpTo_q6va1n_k$(this);
  };
  protoOf(SerializersModuleBuilder).registerSerializer_fk7ob2_k$ = function (forClass, provider, allowOverwrite) {
    if (!allowOverwrite) {
  ...
  protoOf(SerializersModuleBuilder).registerSerializer$default_qp6un6_k$ = function (forClass, provider, allowOverwrite, $super) {
    allowOverwrite = allowOverwrite === VOID ? false : allowOverwrite;
    var tmp;
    if ($super === VOID) {
      this.registerSerializer_fk7ob2_k$(forClass, provider, allowOverwrite);
      tmp = Unit_getInstance();
    } else {
      tmp = $super.registerSerializer_fk7ob2_k$.call(this, forClass, provider, allowOverwrite);
    }
    return tmp;
  };
  protoOf(SerializersModuleBuilder).registerDefaultPolymorphicSerializer_5i0b4y_k$ = function (baseClass, defaultSerializerProvider, allowOverwrite) {
    var previous = this.polyBase2DefaultSerializerProvider_1.get_1mhr4y_k$(baseClass);
  ...
  protoOf(SerializersModuleBuilder).registerDefaultPolymorphicDeserializer_vvbkk4_k$ = function (baseClass, defaultDeserializerProvider, allowOverwrite) {
  ...
  protoOf(SerializersModuleBuilder).registerPolymorphicSerializer_1wc2ku_k$ = function (baseClass, concreteClass, concreteSerializer, allowOverwrite) {
  ...
  protoOf(SerializersModuleBuilder).registerPolymorphicSerializer$default_x4uag2_k$ = function (baseClass, concreteClass, concreteSerializer, allowOverwrite, $super) {
    allowOverwrite = allowOverwrite === VOID ? false : allowOverwrite;
    var tmp;
    if ($super === VOID) {
      this.registerPolymorphicSerializer_1wc2ku_k$(baseClass, concreteClass, concreteSerializer, allowOverwrite);
      tmp = Unit_getInstance();
    } else {
      tmp = $super.registerPolymorphicSerializer_1wc2ku_k$.call(this, baseClass, concreteClass, concreteSerializer, allowOverwrite);
    }
    return tmp;
  };
  ...
  protoOf(SerializersModuleBuilder).polymorphicDefault_zfjs7w_k$ = polymorphicDefault;
  ...
  _.$_$.p1 = decodeCollectionSize;
  _.$_$.q1 = decodeSequentially;
  _.$_$.r1 = CompositeDecoder;
  _.$_$.s1 = shouldEncodeElementDefault;
  _.$_$.t1 = CompositeEncoder;
  _.$_$.u1 = decodeNullableSerializableValue;
  ...
  _.$_$.b2 = Encoder;
  _.$_$.c2 = AbstractPolymorphicSerializer;
  _.$_$.d2 = ArrayListSerializer;
  _.$_$.e2 = ElementMarker;
  _.$_$.f2 = typeParametersSerializers;
  _.$_$.g2 = GeneratedSerializer;
  _.$_$.h2 = HashMapSerializer;
  _.$_$.i2 = HashSetSerializer;
  _.$_$.j2 = InlinePrimitiveDescriptor;
  _.$_$.k2 = NamedValueDecoder;
  _.$_$.l2 = NamedValueEncoder;
  _.$_$.m2 = PluginGeneratedSerialDescriptor;
  _.$_$.n2 = SerializerFactory;
  _.$_$.o2 = createSimpleEnumSerializer;
  _.$_$.p2 = jsonCachedSerialNames;
  _.$_$.q2 = throwMissingFieldException;
  _.$_$.r2 = EmptySerializersModule_0;
  _.$_$.s2 = PolymorphicModuleBuilder;
  _.$_$.t2 = SerializersModuleBuilder;
  _.$_$.u2 = contextual;
  _.$_$.v2 = polymorphicDefault;
  _.$_$.w2 = SerializersModuleCollector;
  _.$_$.x2 = BinaryFormat;
  _.$_$.y2 = DeserializationStrategy;
  _.$_$.z2 = KSerializer;
  _.$_$.a3 = MissingFieldException;
  _.$_$.b3 = SealedClassSerializer;
  _.$_$.c3 = SerializationException;
  _.$_$.d3 = StringFormat;
