...
* [**Reference Monitor**](./RM) - some scenarios may require the presence of a Reference Monitor (RM) mediating users' requests to add and (over)write data to ensure compliance with the access control policy. Concretely, the RM is an extension of *CryptoAC* which can be operated by a partially-trusted agent; 
